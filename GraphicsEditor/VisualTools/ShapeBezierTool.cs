namespace GraphicsEditor.VisualTools
{
    ...
    public class ShapeBezierTool : ShapeTool
    {
        ...
        protected List<Ellipse> EllipsePoints { get; }

        protected List<Point> ReferencePoints { get; }
        ...
        protected override void Drawing(Point currentPoint, Color color)
        {
            ...
            EllipsePoints.Last().Margin = new Thickness(currentPoint.X, currentPoint.Y, 0, 0);
            EllipsePoints.Last().DataContext = EllipsePoints.Last().Margin;
        }

        protected override Shape GenerateShape(Color color)
        {
            EllipsePoints.Add(new Ellipse
            {
            ...
            ReferencePoints.Add(new Point(StartPoint.X + Bias.X, StartPoint.Y + Bias.Y));
        ...
        private void RebuildBezier()
        {
            ...
            for (double t = 0; t < 1; t += Resolution, i++)
            {
                ...
                Point point = BezierCurves.GetPoint((decimal)t, ReferencePoints);
                line.X2 = point.X;
                line.Y2 = point.Y;
                nextLine.X1 = line.X2;
                nextLine.Y1 = line.Y2;
